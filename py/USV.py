...
i = open('input/norton-length12.txt', 'r')
...
with open(newoutputFilename, 'w', newline='') as csvfile:
    ...
    ratingwriter.writerow(['originalPassword'] + ['entropy'] + ['permutedPassword'] + ['newentropy'] + ['lostEntropy'] + ['percentEntropyLoss'] + ['ipadkeystrokes'] + ['newipadkeystrokes'] + ['androidkeystrokes'] + ['newandroidkeystrokes'] + ['desktopkeystrokes'] + ['newdesktopkeystrokes'] + ['passwordlength'] + ['numLetters'] + ['numNumbers'] + ['numSymbols'])
    ...
    for score_list in USG_list:
        ...
        ratingwriter.writerow([current_row['originalPassword'].strip()] + [current_row['originalEntropy']] + [current_row['permutedPassword'].strip()] + [current_row['newEntropy']] + [current_row['lostEntropy']] + [current_row['percentEntropyLoss']] +[current_row['ipadkeystrokes']] + [current_row['newipadkeystrokes']] + [current_row['androidkeystrokes']] + [current_row['newandroidkeystrokes']] + [current_row['desktopkeystrokes']] +[current_row['newdesktopkeystrokes']]+ [current_row['length']] + [current_row['numLetters']] + [current_row['numNumbers']] + [current_row['numSymbols']])
    	password_index += 1
